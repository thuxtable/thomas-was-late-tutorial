...
bool Engine::detectCollisions(PlayableCharacter& character) {
	...
	//Make sure we don't text positions lower than zero or higher than the array's end
	...
	for (int x = startX; x < endX; x++) {
		for (int y = startY; y < endY; y++) {
			...
			//Has character been burnt or drowned? Check head, as this allows him to sink somewhat before death
	...
	//All done: return, whether or not a new level is required
	return reachedGoal;
}